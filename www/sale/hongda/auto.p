  ...
  $menu_namenklatura[^getMachines[]]
   ...
   <ul id="section_id">
    ^menu_namenklatura_brand.menu{
	 ...
	 ^if($menu_namenklatura_brand.tehno_info_uri eq $request:uri){<li class="four"><a href="/catalog/china/hongda/pump/$menu_namenklatura_brand.classification_sub_sub_uri/$menu_namenklatura_brand.translite/">$menu_namenklatura_brand.namenklatura</a></li>}{<li><a href="/catalog/china/hongda/pump/$menu_namenklatura_brand.classification_sub_sub_uri/$menu_namenklatura_brand.translite/">$menu_namenklatura_brand.namenklatura</a></li>}
	 }
}
   </ul>
#@menu_namenklatura[]
