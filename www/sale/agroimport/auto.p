...
@menu_namenklatura[]
  $menu_namenklatura[^getMachines[]]
   $menu_namenklatura_brand[^menu_namenklatura.select($menu_namenklatura.brand_id==6)]
   <h3>Номенклатура</h3>
   $str[$request:uri]
   $parts[^str.split[/;lh]] 
   $parts_parts[$parts.4]
   <ul id="section_id">
    ^menu_namenklatura_brand.menu{
	 ...
	 ^if($menu_namenklatura_brand.tehno_info_uri eq $request:uri){<li class="four"><a href="/catalog/agroimport/$menu_namenklatura_brand.classification_sub_sub_uri/$menu_namenklatura_brand.translite/">$menu_namenklatura_brand.namenklatura</a></li>}{<li><a href="/catalog/agroimport/$menu_namenklatura_brand.classification_sub_sub_uri/$menu_namenklatura_brand.translite/">$menu_namenklatura_brand.namenklatura</a></li>}
	 }
}
   </ul>
#@menu_namenklatura[]
