...
@menu_namenklatura[]
  $menu_namenklatura[^getMachines[]]
   $menu_namenklatura_brand[^menu_namenklatura.select($menu_namenklatura.brand_id==7)]
   <h3>Номенклатура</h3>
   <ul id="section_id">
    ^menu_namenklatura_brand.menu{
           <li class=""><a href="/catalog/belarus/agromash/mashine/detal/id/$menu_namenklatura_brand.id/">$menu_namenklatura_brand.namenklatura</a></li>
}
   </ul>
#@menu_namenklatura[]
