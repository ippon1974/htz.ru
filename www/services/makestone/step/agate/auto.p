...
$result[
	<li>
	<dl>
	<dt><a href="/services/makestone/step/$item/detail/id/${$item.id}/" title="Ступень из $name ${$item.agat_step_name}"><img src="/services/makestone/step/$item/img/list/${$item.agat_step_img}.webp" alt="Ступень из $name ${$item.agat_step_name}" /></a></dt>
