...
^opage.print[
	$.target_url[/services/makestone/table/agate/]
	$.nav_count(50)
	$.mode[html]
]
...
$result[
	...
	<dd class="delta"><a href="/services/makestone/table/$item/detail/id/${$item.id}/" title="Подоконник из $name ${$item.agat_table_name}">Стол из $name ${$item.agat_table_name}</a></dd>
	</dl>
	</li>
]
