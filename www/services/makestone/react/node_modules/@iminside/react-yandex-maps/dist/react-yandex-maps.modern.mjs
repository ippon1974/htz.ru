...
const a = (t, e) => {
  ...
  l = (e) => (n) =>
    /*#__PURE__*/ t.createElement(i.Consumer, null, (o) =>
      /*#__PURE__*/ t.createElement(e, r({ parent: o }, n))
    ),
  p = (t = []) => {
    const [r, a] = n(!1),
      i = o(t),
...
function d(e, n = !1, o = []) {
  return (c) => {
    ...
    return (
      s(() => (h ? f(h) : void 0), [h]),
      y
        ? /*#__PURE__*/ t.createElement(e, r({ ymaps: h }, b))
      ...
      u = o(
        ((t) => {
          const { query: e = h } = t,
            ...
            a = '__yandex-maps-api-onerror__$$' + n,
            c = f ? window : {},
            i = {};
          let l;
          const p = () => (o ? c[o] : l),
            u = () => {
              delete c[s], delete c[a];
            };
          return {
            load: () => {
              if (p()) return Promise.resolve(l);
              if (i[o]) return i[o];
              const n = r({ onload: s, onerror: a }, h, e),
                m = Object.keys(n)
                  .map((t) => `${t}=${n[t]}`)
                  .join('&'),
                d = [
        ...
        })({ version: n, enterprise: a, query: i, preload: l })
      );
    return (
      s(() => {
        l && u.current.load();
      }, [u.current]),
      /*#__PURE__*/ t.createElement(c.Provider, { value: u.current }, p)
    );
  },
  b = /^on(?=[A-Z])/;
function v(t) {
...
const g = (t) => 'default' + t.charAt(0).toUpperCase() + t.slice(1);
function C(t, e) {
  return void 0 !== t[e] || void 0 === t[g(e)];
}
function _(t, e, n) {
  return (C(t, e) ? t[e] : t[g(e)]) || n;
}
...
class x extends t.Component {
  ...
  componentDidCatch(t, e) {
    ...
    n(t), this.setState({ error: t, errorInfo: e });
  }
  render() {
...
const M = (e) => (n) => {
  ...
  /*#__PURE__*/ return t.createElement(
    x,
    { onError: o },
    /*#__PURE__*/ t.createElement(e, s)
  );
};
class k extends t.Component {
  ...
  static updateObject(t, e, n) {
    const { _events: o, instanceRef: s } = v(n),
      { _events: r, instanceRef: a } = v(e);
    if (C(n, 'state')) {
      const o = _(e, 'state', {}),
        s = _(n, 'state', {});
      o.type !== s.type && t.setType(s.type),
        o.behaviors !== s.behaviors &&
          (o.behaviors && t.behaviors.disable(o.behaviors),
          s.behaviors && t.behaviors.enable(s.behaviors)),
        s.zoom && o.zoom !== s.zoom && t.setZoom(s.zoom),
        s.center && o.center !== s.center && t.setCenter(s.center),
        s.bounds && o.bounds !== s.bounds && t.setBounds(s.bounds);
    }
    if (C(n, 'options')) {
      const o = _(e, 'options'),
        s = _(n, 'options', {});
    ...
    (_(e, 'width') === _(n, 'width') && _(e, 'height') === _(n, 'height')) ||
  ...
  static unmountObject(t, e) {
    ...
    null !== t &&
      (Object.keys(o).forEach((e) => O(t, e, o[e])), t.destroy(), R(n));
  }
}
const S = M(d(k, !0, ['Map']));
class T extends t.Component {
    ...
    (this._mounted = !0),
      this.props.ymaps.panorama.isSupported() &&
        T.mountObject(
          ...
          this.props
        ).then((t) => this._mounted && this.setState({ instance: t }));
  }
  componentDidUpdate(t) {
    null !== this.state.instance &&
      T.updateObject(this.state.instance, t, this.props);
  }
  componentWillUnmount() {
  ...
  render() {
    const e = w(this.props);
    /*#__PURE__*/ return t.createElement('div', r({ ref: this._getRef }, e));
  }
  static mountObject(t, e, n) {
    const { instanceRef: o, _events: s } = v(n),
      r = _(n, 'point'),
...
class D extends t.Component {
  ...
  componentDidMount() {
    const t = D.mountControl(
      this.props.ymaps.control[this.props.name],
      this.props
    );
    (this.instance = t), this.setState({ instance: t });
  }
  componentDidUpdate(t) {
    null !== this.instance && D.updateControl(this.instance, t, this.props);
  }
  componentWillUnmount() {
    D.unmountControl(this.instance, this.props);
  }
  render() {
    /*#__PURE__*/ return t.createElement(
      i.Provider,
  ...
  static mountControl(t, e) {
    const { instanceRef: n, parent: o, lazy: s, _events: r } = v(e),
      a = new t({
        data: _(e, 'data'),
        options: _(e, 'options'),
        state: _(e, 'state'),
    ...
    if (
      (Object.keys(r).forEach((t) => j(a, t, r[t])),
  ...
  static unmountControl(t, e) {
    ...
    null !== t &&
      (Object.keys(s).forEach((e) => O(t, e, s[e])),
      o.controls && 'function' == typeof o.controls.remove
        ? o.controls.remove(t)
        : o.remove && 'function' == typeof o.remove && o.remove(t),
      R(n));
  }
}
var B = M(
    l(
      d(
        (e) => /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'Button' })),
        !0,
        ['control.Button']
      )
    )
  ...
  $ = M(
    l(
      d(
        (e) => /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'ListBox' })),
        !0,
        ['control.ListBox']
      )
    )
  ...
  N = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'ListBoxItem' })),
        !0,
        ['control.ListBoxItem']
      )
    )
  ...
  Z = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'RouteButton' })),
        !0,
        ['control.RouteButton']
      )
    )
  ...
  z = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'RouteEditor' })),
        !0,
        ['control.RouteEditor']
      )
    )
  ...
  G = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'RoutePanel' })),
        !0,
        ['control.RoutePanel']
      )
    )
  ...
  I = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'RulerControl' })),
        !0,
  ...
  W = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'SearchControl' })),
        !0,
  ...
  q = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'TypeSelector' })),
        !0,
  ...
  Y = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(D, r({}, e, { name: 'ZoomControl' })),
        !0,
        ['control.ZoomControl']
      )
    )
...
class V extends t.Component {
  ...
  componentDidMount() {
    const t = V.mountObject(this.props.ymaps.Clusterer, this.props);
    (this.instance = t), this.setState({ instance: t });
  }
  componentDidUpdate(t) {
    null !== this.state.instance &&
      V.updateObject(this.instance, t, this.props);
  }
  componentWillUnmount() {
    V.unmountObject(this.instance, this.props);
  }
  render() {
    /*#__PURE__*/ return t.createElement(
      i.Provider,
  ...
  static mountObject(t, e) {
    const { instanceRef: n, parent: o, _events: s } = v(e),
      r = new t(_(e, 'options'));
    if (
      (Object.keys(s).forEach((t) => j(r, t, s[t])),
...
var H = M(l(d(V, !0, ['Clusterer'])));
class J extends t.Component {
  constructor() {
    super(), (this.state = { instance: null });
  }
  componentDidMount() {
    const t = J.mountObject(this.props.ymaps.ObjectManager, this.props);
    (this.instance = t), this.setState({ instance: t });
  }
  componentDidUpdate(t) {
    null !== this.instance && J.updateObject(this.instance, t, this.props);
  }
  componentWillUnmount() {
    J.unmountObject(this.instance, this.props);
  }
  render() {
    return null;
  }
  static mountObject(t, e) {
    ...
    if (
      ...
      Object.keys(s).forEach((t) => j(p, t, s[t])),
      o.geoObjects && 'function' == typeof o.geoObjects.add)
    )
      o.geoObjects.add(p);
    else {
...
var K = M(l(d(J, !0, ['ObjectManager'])));
class Q extends t.Component {
  constructor() {
    super(), (this.state = { instance: null }), (this.instance = null);
  }
  componentDidMount() {
    const { name: t, ymaps: e, dangerZone: n } = this.props,
      o = Q.mountObject(
        n && 'function' == typeof n.modifyConstructor
          ? n.modifyConstructor(e[t])
          : e[t],
        this.props
      );
  ...
  componentDidUpdate(t) {
    null !== this.instance && Q.updateObject(this.instance, t, this.props);
  }
  componentWillUnmount() {
    Q.unmountObject(this.instance, this.props);
  }
  render() {
    return null;
  }
    ...
    if (C(n, 'geometry')) {
      ...
      Array.isArray(s) && s !== o
        ? Array.isArray(s[0]) && 'number' == typeof s[1]
          ? (t.geometry.setCoordinates(s[0]), t.geometry.setRadius(s[1]))
          : t.geometry.setCoordinates(s)
        : 'object' == typeof s &&
          (s.coordinates !== o.coordinates &&
            t.geometry.setCoordinates(s.coordinates),
          s.radius !== o.radius && t.geometry.setRadius(s.radius));
    }
    if (C(n, 'properties')) {
...
var tt = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(
            Q,
            r({}, e, { name: 'GeoObject', dangerZone: X })
          ),
        !0,
        ['GeoObject']
      )
  ...
  et = M(
    l(
      d(
        (e) => /*#__PURE__*/ t.createElement(Q, r({}, e, { name: 'Circle' })),
        !0,
        ['Circle']
      )
    )
  ...
  nt = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(Q, r({}, e, { name: 'Placemark' })),
        !0,
        ['Placemark']
      )
    )
  ...
  ot = M(
    l(
      d(
        (e) => /*#__PURE__*/ t.createElement(Q, r({}, e, { name: 'Polygon' })),
        !0,
        ['Polygon']
      )
    )
  ...
  st = M(
    l(
      d(
        (e) => /*#__PURE__*/ t.createElement(Q, r({}, e, { name: 'Polyline' })),
        !0,
        ['Polyline']
      )
    )
  ...
  rt = M(
    l(
      d(
        (e) =>
          /*#__PURE__*/ t.createElement(Q, r({}, e, { name: 'Rectangle' })),
        !0,
        ['Rectangle']
      )
    )
