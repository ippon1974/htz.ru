...
const s = (e, t) => {
  ...
  r = /*#__PURE__*/ n.default.createContext(null),
  a = /*#__PURE__*/ n.default.createContext(null),
  c = (e) => (t) =>
    /*#__PURE__*/ n.default.createElement(a.Consumer, null, (s) =>
      /*#__PURE__*/ n.default.createElement(e, o({ parent: s }, t))
    ),
  i = (t = []) => {
    ...
    return (
      e.useEffect(() => {
        a.load()
          .then(() => Promise.all(s.current.map(a.loadModule)))
          .then(() => o(!0));
      }, []),
      n && c ? c : null
    );
  ...
  l = () => {},
  u = ['onLoad', 'onError', 'modules', 'apiLoader'];
function p(t, r = !1, a = []) {
  return (c) => {
    const { width: p, height: d, modules: f = [], onLoad: m = l } = c,
      h = i(a.concat(f)),
      y = !r || !!h,
      b = s(c, u);
    return (
      e.useEffect(() => (h ? m(h) : void 0), [h]),
      y
        ? /*#__PURE__*/ n.default.createElement(t, o({ ymaps: h }, b))
        : /*#__PURE__*/ n.default.createElement('div', {
            style: { width: p, height: d },
          })
    );
  };
}
const d = 'undefined' != typeof window,
  f = { lang: 'ru_RU', load: '', ns: '', mode: 'release' },
  m = /^on(?=[A-Z])/;
function h(e) {
  return Object.keys(e).reduce(
    (t, n) => {
      if (m.test(n)) {
        const o = n.replace(m, '').toLowerCase();
        t._events[o] = e[n];
      } else t[n] = e[n];
      return t;
    },
...
function v(e, t, n) {
  Object.keys(Object.assign({}, t, n)).forEach((o) => {
    t[o] !== n[o] && (b(e, o, t[o]), y(e, o, n[o]));
  });
}
const j = (e) => 'default' + e.charAt(0).toUpperCase() + e.slice(1);
function O(e, t) {
  return void 0 !== e[t] || void 0 === e[j(t)];
}
function E(e, t, n) {
  return (O(e, t) ? e[t] : e[j(t)]) || n;
}
...
const _ =
  (e) =>
  ({ onError: t, ...o }) =>
    /*#__PURE__*/ n.default.createElement(
      R,
      { onError: t },
      /*#__PURE__*/ n.default.createElement(e, o)
    );
class x extends n.default.Component {
  ...
  componentDidUpdate(e) {
    null !== this.instance && x.updateObject(this.instance, e, this.props);
  }
  componentWillUnmount() {
    x.unmountObject(this.instance, this.props);
  }
  render() {
    ...
    /*#__PURE__*/ return n.default.createElement(
      a.Provider,
      { value: this.state.instance },
      /*#__PURE__*/ n.default.createElement(
        'div',
        o({ ref: this._getRef }, e, r),
        this.props.children
      )
    );
  }
  static mountObject(e, t, n) {
    const { instanceRef: o, _events: s } = h(n),
      r = new t(e, E(n, 'state'), E(n, 'options'));
    return Object.keys(s).forEach((e) => y(r, e, s[e])), g(null, o, r), r;
  }
  static updateObject(e, t, n) {
    const { _events: o, instanceRef: s } = h(n),
      { _events: r, instanceRef: a } = h(t);
    if (O(n, 'state')) {
      const o = E(t, 'state', {}),
        s = E(n, 'state', {});
    ...
    (E(t, 'width') === E(n, 'width') && E(t, 'height') === E(n, 'height')) ||
      e.container.fitToViewport(),
      v(e, r, o),
      g(a, s, e);
  }
  static unmountObject(e, t) {
    const { instanceRef: n, _events: o } = h(t);
    null !== e &&
      (Object.keys(o).forEach((t) => b(e, t, o[t])), e.destroy(), g(n));
  }
}
const w = _(p(x, !0, ['Map']));
class P extends n.default.Component {
  ...
  componentDidUpdate(e) {
    null !== this.state.instance &&
      P.updateObject(this.state.instance, e, this.props);
  }
  componentWillUnmount() {
    (this._mounted = !1), P.unmountObject(this.state.instance, this.props);
  }
  render() {
    const e = C(this.props);
    /*#__PURE__*/ return n.default.createElement(
      'div',
      o({ ref: this._getRef }, e)
    );
  }
  static mountObject(e, t, n) {
    const { instanceRef: o, _events: s } = h(n),
    ...
    return new Promise((n, i) => {
      t.locate(r, a).done((r) => {
        if (r.length > 0) {
          ...
          g(null, o, a), Object.keys(s).forEach((e) => y(a, e, s[e])), n(a);
        }
      }, i);
    });
  }
  ...
  static unmountObject(e, t) {
    const { instanceRef: n, _events: o } = h(t);
    null !== e && (Object.keys(o).forEach((t) => b(e, t, o[t])), g(n));
  }
}
const M = _(
  p(P, !0, [
...
class k extends n.default.Component {
  constructor() {
    super(), (this.state = { instance: null }), (this.instance = null);
  }
  componentDidMount() {
    const e = k.mountControl(
  ...
  componentDidUpdate(e) {
    null !== this.instance && k.updateControl(this.instance, e, this.props);
  }
  componentWillUnmount() {
    k.unmountControl(this.instance, this.props);
  }
  render() {
    /*#__PURE__*/ return n.default.createElement(
      a.Provider,
  ...
  static mountControl(e, t) {
    const { instanceRef: n, parent: o, lazy: s, _events: r } = h(t),
      a = new e({
        data: E(t, 'data'),
        options: E(t, 'options'),
        state: E(t, 'state'),
        mapTypes: E(t, 'mapTypes'),
        lazy: s,
      });
    if (
      (Object.keys(r).forEach((e) => y(a, e, r[e])),
  ...
  static unmountControl(e, t) {
    const { instanceRef: n, parent: o, _events: s } = h(t);
    null !== e &&
      (Object.keys(s).forEach((t) => b(e, t, s[t])),
...
class W extends n.default.Component {
  ...
  static mountObject(e, t) {
    const { instanceRef: n, parent: o, _events: s } = h(t),
      r = new e(E(t, 'options'));
    if (
      (Object.keys(s).forEach((e) => y(r, e, s[e])),
...
var Y = _(c(p(W, !0, ['Clusterer'])));
class q extends n.default.Component {
  constructor() {
    super(), (this.state = { instance: null });
  }
  componentDidMount() {
    const e = q.mountObject(this.props.ymaps.ObjectManager, this.props);
    (this.instance = e), this.setState({ instance: e });
  }
  componentDidUpdate(e) {
    null !== this.instance && q.updateObject(this.instance, e, this.props);
  }
  componentWillUnmount() {
  ...
  static mountObject(e, t) {
    ...
    if (
      ...
      Object.keys(s).forEach((e) => y(u, e, s[e])),
      o.geoObjects && 'function' == typeof o.geoObjects.add)
    )
      o.geoObjects.add(u);
    else {
...
class V extends n.default.Component {
  ...
  componentDidUpdate(e) {
    null !== this.instance && V.updateObject(this.instance, e, this.props);
  }
  componentWillUnmount() {
  ...
  static mountObject(e, t) {
    const { instanceRef: n, parent: o, _events: s } = h(t),
      r = new e(E(t, 'geometry'), E(t, 'properties'), E(t, 'options'));
    if (
      (Object.keys(s).forEach((e) => y(r, e, s[e])),
    ...
    c(
      p(
        (e) =>
          /*#__PURE__*/ n.default.createElement(
            V,
            o({}, e, { name: 'GeoObject', dangerZone: H })
          ),
        !0,
        ['GeoObject']
      )
...
(exports.Button = S),
  (exports.Circle = K),
  (exports.Clusterer = Y),
  (exports.FullscreenControl = T),
  (exports.GeoObject = J),
  (exports.GeolocationControl = U),
  (exports.ListBox = D),
  (exports.ListBoxItem = B),
  (exports.Map = w),
  (exports.ObjectManager = F),
  (exports.Panorama = M),
  (exports.Placemark = Q),
  (exports.Polygon = X),
  (exports.Polyline = ee),
  (exports.Rectangle = te),
  (exports.RouteButton = A),
  (exports.RouteEditor = L),
  (exports.RoutePanel = $),
  (exports.RulerControl = N),
  (exports.SearchControl = Z),
  (exports.TrafficControl = z),
  (exports.TypeSelector = G),
  (exports.YMaps = (t) => {
    const {
        version: o = '2.1',
        enterprise: s = !1,
      ...
      l = e.useRef(
        ((e) => {
          ...
          return {
            load: () => {
              ...
              if (c[o]) return c[o];
              const n = { onload: s, onerror: r, ...f, ...t },
                p = Object.keys(n)
                  .map((e) => `${e}=${n[e]}`)
                  .join('&'),
                d = [
        ...
        })({ version: o, enterprise: s, query: a, preload: c })
      );
    return (
      e.useEffect(() => {
        c && l.current.load();
      }, [l.current]),
      /*#__PURE__*/ n.default.createElement(r.Provider, { value: l.current }, i)
    );
  }),
  (exports.ZoomControl = I),
  (exports.useYMaps = i),
  (exports.withYMaps = p);
