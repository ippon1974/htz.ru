...
@title[]
$title[^db::getMarbleTableTop[$.id(^form:id.int(0))]]
^if(def $title){ 
$result[Столешница из мрамора $title.marble_tabletop_name для кунхи]
}{ 
$result[]
} 
#@title[]
...
@navi_center_id[name]
$navi_center_id[^db::getMarbleTableTop[$.id(^form:id.int(0))]]
$result[<span style="background: #FFFFCC^;">Столешница из $name $navi_center_id.marble_tabletop_name</span>]
#@navi_center_id[]

@tabletop_detail[item;name]
^hMakeStone[]
$detail_tabletop_$item[^db::getMarbleTableTop[$.id(^form:id.int(0))]]
...
<div id="">
<h1>Столешница из $name $detail_tabletop_$item.marble_tabletop_name для кунхи. Образец.</h1>
</div>
...
<a href="/services/makestone/tabletop/$item/img/big/${detail_tabletop_$item.marble_tabletop_img}.webp" target="_blank" title="Столешница из $name $detail_tabletop_$item.marble_tabletop_name для кунхи"><img src="/services/makestone/tabletop/$item/img/list/${detail_tabletop_$item.marble_tabletop_img}.webp" alt="Столешница из $name $detail_tabletop_$item.marble_tabletop_name для кунхи" /></a>
...
<h3>Другие изделия из $name $detail_tabletop_$item.marble_tabletop_name</h3>
