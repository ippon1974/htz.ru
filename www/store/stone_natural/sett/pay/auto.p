...
@title[]
Брусчатка из природного камня с сортировкой по цене
#@title[]
...
^if(!def $form:products_format_type_size){
 ...
 <tr>
	...
	<th>Размеры</th>
	<th>Цвет</th>
	<th><a href="/store/stone_natural/sett/">Руб.</a></th>
    <th><a href="/store/stone_natural/sett/">^$</a></th>
</tr>
   ^sett_cell.sort($sett_cell.pay)
   ^sett_cell.menu{ 
   <tr>
   <td>$sett_cell.id</td>
