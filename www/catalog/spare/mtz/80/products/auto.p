...
<ul>
    ^products_cell.menu{
      <li><a href="/catalog/spare/mtz/80/products/detal/id/$products_cell.id/" title="$products_cell.name">$products_cell.name</a> <em style="color:#7e7e7e^;">^products_cell.product_code.trim[]</em></li>
      }
</ul>
#@detail[]
