...
@title[]
$result[Утеплители моторов для тракторов. КАМАЗ ПАО КАМАЗ.]
#end @title[]
...
<h3 id="ins_amkodor">${h_Insulation.factory.[12]} ${h_Insulation.factory_desc.[12]}</h3>
<table class="price_table" cellspacing="0">
<tr>
<th>Название</th>
<th>Цена</th>
</tr>
$ins_amkodor[^insulation.select($insulation.tech_id==12)]
^ins_amkodor.menu{
    <tr>
