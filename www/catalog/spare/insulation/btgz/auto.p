...
@title[]
$result[Утеплители моторов для тракторов. ВТГЗ Волгоградский тракторный завод]
#end @title[]
...
<h3 id="ins_amkodor">${h_Insulation.factory.[3]} ${h_Insulation.factory_desc.[3]}</h3>
<table class="price_table" cellspacing="0">
<tr>
<th>Название</th>
<th>Цена</th>
</tr>
$ins_amkodor[^insulation.select($insulation.tech_id==3)]
^ins_amkodor.menu{
    <tr>
