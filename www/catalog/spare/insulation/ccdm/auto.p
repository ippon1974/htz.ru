...
@title[]
$result[Утеплители моторов для тракторов. ЧСДМ Челябинские строительно-дорожные машины.]
#end @title[]
...
<h3 id="ins_amkodor">${h_Insulation.factory.[15]} ${h_Insulation.factory_desc.[15]}</h3>
<table class="price_table" cellspacing="0">
<tr>
<th>Название</th>
<th>Цена</th>
</tr>
$ins_amkodor[^insulation.select($insulation.tech_id==15)]
^ins_amkodor.menu{
    <tr>
