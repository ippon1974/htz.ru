...
@title[]
$result[Утеплители моторов для тракторов. ГАЗ Горьковский автомобильный завод.]
#end @title[]
...
<h3 id="ins_amkodor">${h_Insulation.factory.[17]} ${h_Insulation.factory_desc.[17]}</h3>
<table class="price_table" cellspacing="0">
<tr>
<th>Название</th>
<th>Цена</th>
</tr>
$ins_amkodor[^insulation.select($insulation.tech_id==17)]
^ins_amkodor.menu{
    <tr>
