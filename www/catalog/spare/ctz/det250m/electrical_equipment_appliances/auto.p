...
@print_engine_cell[]
<li><a href="/catalog/spare/ctz/det250m/electrical_equipment_appliances/id/$engine_cell.id/">$engine_cell.name</a></li>
...
^if(!def $form:id){
	$engine[^getCategories[]]
	  $engine_cell[^engine.select($engine.catalog_id==8)]
	^if($engine_cell){
		^print_engine[$engine_cell]
	}{
		<p>Не найдено.</p>
