...
^if(!def $form:id){
$pets[ 
   $.161[Электрооборудование тракторов] 
   $.165[Электрооборудование двигателя]
   $.176[Щитки приборов и их элементы]
   $.184[Электрооборудование кабины]
]
 <ul>
^pets.foreach[key;value]{ 
       <li><a href="/catalog/spare/ctz/t170/electric/id/$key/" title="$value">$value</a></li>
}</ul>
