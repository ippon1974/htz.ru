...
@print_engine_cell[]
<li><a href="/catalog/spare/ctz/t170/engine/id/$engine_cell.categories_id/">$engine_cell.name_categories</a></li>
...
^if(!def $form:id){
$pets[ 
   $.2[Основные элементы двигателя] 
   $.27[Система охлаждения] 
   $.35[Система смазки]
   $.45[Система питания и ее элементы]
]
 <ul>
^pets.foreach[key;value]{ 
       <li><a href="/catalog/spare/ctz/t170/engine/id/$key/" title="$value">$value</a></li>
}</ul>
