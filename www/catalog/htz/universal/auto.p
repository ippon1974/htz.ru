...
<meta name="description" content="^title_htz[] |" />
<meta name="keywords" content="^title_htz[] |" />
...
$str[$request:uri]
 ...
 }{$result[Тракторы общего назначения заводской сборки ОАО «ХТЗ».]}
#@title[]
...
^hMachines[]
 $mashine[^getMachines[]]
  ...
  $mashine_s_s[^mashine_s.select($mashine_s.classification_sub==5)]
  $price[^getPriceMachines[]]
  $price_hash[^price.hash[id]]  
  <h2>Пахатно-пропашные тракторы сборки ОАО &laquo^;ХТЗ&raquo^;.</h2>
  <ul class="listing">
  ^mashine_s_s.menu{
