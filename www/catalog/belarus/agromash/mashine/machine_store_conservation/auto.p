...
^hMachines[]
 $mashine[^getMachines[]]
  ...
  $mashine_s_s[^mashine_s.select($mashine_s.classification==21)]
  ...
  ^mashine_s_s.menu{ 
	...
	<li>
    <dl>	
    <dt>^if(def $mashine_s_s.img_front){<a href="/catalog/belarus/agromash/mashine/detal/id/$mashine_s_s.id/" title="$mashine_s_s.title"><img src="/catalog/img/front/${mashine_s_s.img_front}.jpg" alt="$mashine_s_s.title" /></a>}{} <a href="/catalog/belarus/agromash/mashine/detal/id/$mashine_s_s.id/" title="$mashine_s_s.title">$mashine_s_s.title</a></dt>
