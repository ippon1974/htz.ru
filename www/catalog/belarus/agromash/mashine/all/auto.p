...
^hMachines[]
 $mashine[^getMachines[]]
  ...
  ^mashine_s.menu{ 
	...
	<li>
    <dl>	
    <dt>^if(def $mashine_s.img_front){<a href="/catalog/belarus/agromash/mashine/detal/id/$mashine_s.id/" title="$mashine_s.title"><img src="/catalog/img/front/${mashine_s.img_front}.jpg" alt="$mashine_s.title" /></a>}{} <a href="/catalog/belarus/agromash/mashine/detal/id/$mashine_s.id/" title="$mashine_s.title">$mashine_s.title</a></dt>
