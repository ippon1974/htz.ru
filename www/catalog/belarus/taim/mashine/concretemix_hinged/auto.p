...
^hMachines[]
 $mashine[^getMachines[]]
  ...
  $mashine_s_s[^mashine_s.select($mashine_s.classification==28)]
  ...
  ^mashine_s_s.menu{ 
    ...
    <dd>^if($mashine_price){$text(^eval($mashine_price*^exchange_usd[])) <strong style="color:#ff0000^;">$text</strong> руб. <em style="color: #143B27^; font-size: 0.9em^;">$text_nds($text/6.55557)}</em></dd>					
