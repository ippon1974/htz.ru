...
^hMachines[]
 $mashine[^getMachines[]]
  ...
  $mashine_s_s[^mashine_s.select($mashine_s.classification==23)]
  ...
  ^mashine_s_s.menu{ 
    ...
    <dd>^if($mashine_price){$text(^eval($mashine_price*^exchange_usd[])) $text руб. <em style="color: #143B27^; font-size: 0.9em^;">$text_nds($text/6.55557) ^int2str:money2str($text)}</em></dd>					
