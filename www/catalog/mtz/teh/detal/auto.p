@title[]
$title[^getTehMTZ[$.id(^form:id.int(0))]]
$result[Технические характеристики трактора $title.namenklatura (Беларус $title.namenklatura) сборки (ПО "МТЗ")]
#@title[]

@getMTZ[]
$teh[^getTehMTZ[$.id(^form:id.int(0))]]
$field_teh[^table::load[/field_teh_mtz.cfg]]

^navi_sub_nav_[]
<div>
<h1>Технические характеристики трактора $teh.namenklatura</h1>
</div>
