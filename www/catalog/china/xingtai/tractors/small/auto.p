...
^hMachines[]
  ...
  $mashine_s_s[^mashine_s.select($mashine_s.classification_item==2)]
  ...
  $str[$request:uri] 
  $parts[^str.split[/;lh]]
 <div style="margin: 0 0 0.8em 0^; font-size: 1.5em^;"><a href="/catalog/china/xingtai/tractors/" title="Тракторы &laquo^;XINGTAI&raquo^;">Тракторы &laquo^;XINGTAI&raquo^;</a></div>
  <h2>^title[].</h2>
  <ul class="listing">
  <form action="/catalog/china/xingtai/tractors/compare/" method="POST">
  ...
  ^mashine_s_s.menu{
	...
	<li>
    <dl>	
    <dt>^if(def $parts.0){<a href="/catalog/china/xingtai/tractors/detal/id/$mashine_s_s.id/" title="$mashine_s_s.title"><img src="/catalog/img/front/${parts.0}.jpg" alt="$mashine_s_s.title" /></a>}{} <a href="/catalog/china/xingtai/tractors/detal/id/$mashine_s_s.id/" title="$mashine_s_s.title">$mashine_s_s.title</a></dt>
