...
@namenklatura[]
   ...
   $menu_namenklatura_teh[^getTehXingtai[$.id(^form:id.int(0))]]
   $menu_namenklatura_brand[^menu_namenklatura.select($menu_namenklatura.brand_id==10)]
   ...
   <ul id="section_id">
    ^menu_namenklatura_brand.menu{
	 ...
	 ^if(def $form:id){^if($menu_namenklatura_brand.id==$menu_namenklatura_teh.machines_id){<li class="four"><a href="/catalog/china/xingtai/tractors/detal/id/$menu_namenklatura_brand.id/">$menu_namenklatura_brand.namenklatura</a></li>}{<li><a href="/catalog/china/xingtai/tractors/detal/id/$menu_namenklatura_brand.id/">$menu_namenklatura_brand.namenklatura</a></li>}
	 }{
	 ^if($menu_namenklatura_brand.tehno_info_uri eq $request:uri){<li class="four"><a href="/catalog/china/xingtai/tractors/detal/id/$menu_namenklatura_brand.id/">$menu_namenklatura_brand.namenklatura</a></li>}{<li><a href="/catalog/china/xingtai/tractors/detal/id/$menu_namenklatura_brand.id/">$menu_namenklatura_brand.namenklatura</a></li>}
	 }
	 }
...
^if(def $form:do){
	...
	^if(^is_ok[]){
		...
		^rem{ *** при этом уже заполненные ранее пользователям данные не будут потеряны *** }
