...
^hMachines[]
 $description[^getMachines[]]
  ^if(^description.locate[translite;$form:translite]){$result[$h_Machines.description.[$description.classification]]}{$result[Стационарные бетононасосы от компании  Changsha Zoomlion Heavy Industry Science & Technology Development Co., Ltd]}
#@description[]

@keywords[]
^hMachines[]
 $keywords[^getMachines[]]
  ^if(^keywords.locate[translite;$form:translite]){$result[$h_Machines.keywords.[$keywords.classification]]}{$result[Стационарные бетононасосы от компании  Changsha Zoomlion Heavy Industry Science & Technology Development Co., Ltd]}
#@description[]
...
^hMachines[]
 ...
 $PumpHngda_brand[^PumpHngda.select($PumpHngda.brand_id==4)]
  $PumpHngda_select[^PumpHngda_brand.select($PumpHngda.classification==1)] 
   <h2>Стационарные бетононасосы от компании Changsha Zoomlion Heavy Industry Science & Technology Development Co., Ltd</h2>
   <ul class="listing">
...
@navi_sub_nav[]
 $navi_sub_nav[^getMachines[]]
    ^if(^navi_sub_nav.locate[tehno_info_uri;$request:uri]){<div><a href="/catalog/china/zoomlion/pump/$navi_sub_nav.classification_sub_sub_uri/$navi_sub_nav.translite/">$navi_sub_nav.brand $navi_sub_nav.namenklatura</a></div><br />}{} 
#@navi_sub_nav[]

@navi_sub_nav_add[]
 $navi_sub_nav[^getMachines[]]
    ^if(^navi_sub_nav.locate[complect_uri;$request:uri]){<div><a href="/catalog/china/zoomlion/pump/$navi_sub_nav.classification_sub_sub_uri/$navi_sub_nav.translite/">$navi_sub_nav.brand $navi_sub_nav.namenklatura</a></div><br />}{} 
#@navi_sub_nav_add[]

@menu_batton[]
  $menu_batton[^getMachines[]]
   $menu_batton_brand[^menu_batton.select($menu_batton.brand_id==4)]
   ...
   <ul>
    ^menu_batton_select.menu{
	 ...
	 <li><a href="/catalog/china/zoomlion/pump/$menu_batton_select.classification_sub_sub_uri/$menu_batton_select.translite/">$menu_batton_select.name_ru</a></li>
	 }
...
@menu_namenklatura[]
  $menu_namenklatura[^getMachines[]]
   $menu_namenklatura_brand[^menu_namenklatura.select($menu_namenklatura.brand_id==4)]
   ...
   <ul id="section_id">
    ^menu_namenklatura_select.menu{
	 ...
	 ^if($menu_namenklatura_select.tehno_info_uri eq $request:uri){<li class="four"><a href="/catalog/china/zoomlion/pump/$menu_namenklatura_select.classification_sub_sub_uri/$menu_namenklatura_select.translite/">$menu_namenklatura_select.namenklatura</a></li>}{<li><a href="/catalog/china/zoomlion/pump/$menu_namenklatura_select.classification_sub_sub_uri/$menu_namenklatura_select.translite/">$menu_namenklatura_select.namenklatura</a></li>}
	 }
