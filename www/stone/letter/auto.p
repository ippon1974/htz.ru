...
<li>
<dl>
<dt><a href="/stone/all/select/$cell.id/"><img src="/stone/img/small/$cell.img_small" alt="^if(def $cell.name_ru){^cell.name_ru.match[[\[\]]][g]{}}{$cell.name_en}" /></a> ^if(def $cell.name_ru){<a href="/stone/all/select/$cell.id/">^cell.name_ru.match[[\[\]]][g]{}</a>}{<a href="/stone/all/select/$cell.id/">$cell.name_en</a>}
...
<li>
<dl>
<dt>^if(def $cell.name_ru){<a href="/stone/all/select/$cell.id/">^cell.name_ru.match[[\[\]]][g]{}</a>}{<a href="/stone/all/select/$cell.id/">$cell.name_en</a>}</dt>
<span style="font-weight: bold^; color: #9A9A9A^; font-size: 0.8em^; font-style: italic^;">Номер для заказа  #$cell.id</span>					
<dd><img style="margin: 0 5px 0 0^;" src="/stone/img/i/$cell.flag" alt="" /> $cell.country_ru</dd>
